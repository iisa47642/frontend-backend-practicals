...
// Получение события от других клиентов через WebSocket
...
// Функции для работы с push-подписками
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BGOiOrDWWagD6huUgmPWPrJ_BIYU1eJpG2UJN8yskO-RyE4KOhZaFNbi9ng8-JuA3K_jaJI3cNljDrhbSz8bby0')
        });
...
// Регистрация Service Worker и управление push-кнопками
